...
<head>
    ...
    <title>Superadmin Dashboard - SmartHarvest</title>
...
<body class="bg-gray-50" x-data="superadminDashboard()">
    <div class="flex h-screen">
        ...
        <aside class="w-64 bg-gradient-to-b from-purple-800 to-purple-900 text-white flex-shrink-0">
            ...
            <nav class="p-4 space-y-2">
                <div class="mb-4">
                    <p class="text-xs uppercase text-purple-300 mb-2 px-4" data-translate data-translate-id="sidebar-overview">OVERVIEW</p>
                    <a href="{{ route('admin.dashboard') }}" class="sidebar-item active flex items-center space-x-3 px-4 py-3 rounded bg-purple-600">
                ...
                <div class="mb-4">
                    <p class="text-xs uppercase text-purple-300 mb-2 px-4" data-translate data-translate-id="sidebar-user-mgmt">USER MANAGEMENT</p>
                ...
                <div class="mb-4">
                    <p class="text-xs uppercase text-purple-300 mb-2 px-4" data-translate data-translate-id="sidebar-data-mgmt">DATA MANAGEMENT</p>
                ...
                <div class="mb-4">
                    <p class="text-xs uppercase text-purple-300 mb-2 px-4" data-translate data-translate-id="sidebar-system">SYSTEM</p>
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="bg-white shadow-sm p-4 flex justify-between items-center border-b">
                <div class="flex items-center space-x-3">
                    ...
                    <h2 class="text-xl font-semibold text-gray-800" data-translate data-translate-id="header-title">Superadmin Dashboard</h2>
                    <span class="ml-2 px-3 py-1 bg-purple-100 text-purple-800 text-xs font-bold rounded-full">👑 SUPERADMIN</span>
                </div>
            ...
            <main class="flex-1 overflow-y-auto p-6 bg-gray-50">
                <!-- Overview Stats Cards - System Admin Focus -->
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                    <!-- Total Users Card -->
                    <div class="stat-card bg-white rounded-xl shadow-sm p-5 border border-purple-100">
                        <div class="flex justify-between items-start">
                            <div>
                                <p class="text-xs text-gray-500 mb-1">Total Users</p>
                                <h3 class="text-2xl font-bold text-gray-800" x-text="stats.totalUsers.toLocaleString()">0</h3>
                    ...
                    <!-- DA Admins Card -->
                    <div class="stat-card bg-white rounded-xl shadow-sm p-5 border border-blue-100">
                        <div class="flex justify-between items-start">
                            <div>
                                <p class="text-xs text-gray-500 mb-1">DA-CAR Officers</p>
                                <h3 class="text-2xl font-bold text-gray-800" x-text="daAdmins.length || '0'">0</h3>
                                <p class="text-xs text-blue-600 mt-1">Active administrators</p>
                            </div>
                    ...
                    <!-- System Status Card -->
                    <div class="stat-card bg-white rounded-xl shadow-sm p-5 border border-green-100">
                        <div class="flex justify-between items-start">
                            <div>
                    ...
                    <div class="stat-card bg-white rounded-xl shadow-sm p-5 border border-yellow-100">
                        <div class="flex justify-between items-start">
                            <div>
                                <p class="text-xs text-gray-500 mb-1">Pending Actions</p>
                                <h3 class="text-2xl font-bold text-gray-800" x-text="stats.pendingActions">0</h3>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-6 border border-purple-100">
                        <h3 class="text-lg font-semibold text-purple-700 mb-4">Quick Admin Actions</h3>
                        <div class="grid grid-cols-2 gap-3">
                            <a href="{{ route('admin.users') }}" class="flex items-center space-x-3 p-3 bg-purple-50 rounded-lg hover:bg-purple-100 transition">
                            ...
                            <a href="{{ route('admin.roles') }}" class="flex items-center space-x-3 p-3 bg-blue-50 rounded-lg hover:bg-blue-100 transition">
                            ...
                            <a href="{{ route('admin.datasets') }}" class="flex items-center space-x-3 p-3 bg-green-50 rounded-lg hover:bg-green-100 transition">
                                ...
                                <span class="text-sm font-medium text-gray-700">View Datasets</span>
                            </a>
                            <a href="{{ route('admin.monitoring') }}" class="flex items-center space-x-3 p-3 bg-yellow-50 rounded-lg hover:bg-yellow-100 transition">
                                <div class="bg-yellow-500 p-2 rounded-lg">
                                    <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M3 3a1 1 0 000 2v8a2 2 0 002 2h2.586l-1.293 1.293a1 1 0 101.414 1.414L10 15.414l2.293 2.293a1 1 0 001.414-1.414L12.414 15H15a2 2 0 002-2V5a1 1 0 100-2H3zm11.707 4.707a1 1 0 00-1.414-1.414L10 9.586 8.707 8.293a1 1 0 00-1.414 0l-2 2a1 1 0 101.414 1.414L8 10.414l1.293 1.293a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                                    </svg>
                                </div>
                                <span class="text-sm font-medium text-gray-700">System Monitoring</span>
                            </a>
                        </div>
                    </div>

                    <!-- Active DA-CAR Officers Overview -->
                    <div class="bg-white rounded-xl shadow-sm p-6 border border-blue-100">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-lg font-semibold text-blue-700">Active DA-CAR Officers</h3>
                            <button @click="showAddAdminModal = true" class="text-xs bg-blue-600 text-white px-3 py-1 rounded-lg hover:bg-blue-700">+ Add Officer</button>
                        </div>
                        <div class="space-y-3 max-h-40 overflow-y-auto">
                            <template x-for="admin in daAdmins.slice(0, 5)" :key="admin.id">
                                <div class="flex items-center justify-between p-2 bg-gray-50 rounded-lg">
                                    <div class="flex items-center space-x-3">
                                        <div class="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center">
                                            <span class="text-blue-600 text-xs font-bold" x-text="admin.name.charAt(0).toUpperCase()"></span>
                                        </div>
                                        <div>
                            ...
                            <div x-show="daAdmins.length === 0" class="text-center py-4 text-gray-500 text-sm">
                                No DA-CAR officers assigned yet
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <!-- DA Admin Management Section (Superadmin Only) -->
                @if(Auth::user()->is_superadmin)
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 mb-6">
                    <div class="p-6 border-b border-gray-100">
                        <div class="flex justify-between items-center">
                            <div>
                                <h3 class="text-lg font-semibold text-blue-700">DA Admin Management</h3>
                                <p class="text-sm text-gray-500">Add or remove DA Admin privileges by user email</p>
                            </div>
                            <button @click="showAddAdminModal = true" class="flex items-center space-x-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"/>
                                </svg>
                                <span>Add DA Admin</span>
                            </button>
                        </div>
                    </div>
                    
                    <!-- Current DA Admins List -->
                    <div class="p-6">
                        <div class="mb-4">
                            <p class="text-sm font-medium text-gray-700">Current DA Admins (<span x-text="daAdmins.length"></span>)</p>
                        </div>
                        <div class="overflow-x-auto">
                            <table class="w-full" x-show="daAdmins.length > 0">
                                ...
                                <tbody class="divide-y divide-gray-100">
                                    <template x-for="admin in daAdmins" :key="admin.id">
                                        <tr class="hover:bg-gray-50">
                                            <td class="px-4 py-3">
                                                <div class="flex items-center">
                                                    <div class="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center text-white text-sm font-semibold">
                                                        <span x-text="admin.name.charAt(0).toUpperCase()"></span>
                                                    </div>
                                                    <span class="ml-3 text-sm font-medium text-gray-900" x-text="admin.name"></span>
                                                </div>
                                            </td>
                                            <td class="px-4 py-3 text-sm text-gray-600" x-text="admin.email"></td>
                                            <td class="px-4 py-3 text-sm text-gray-600" x-text="admin.created_at"></td>
                                            <td class="px-4 py-3 text-sm text-gray-500" x-text="admin.last_login"></td>
                                            <td class="px-4 py-3">
                                                <button @click="removeAdmin(admin)" class="px-3 py-1.5 text-sm bg-red-100 text-red-700 rounded-lg hover:bg-red-200 transition-colors">
                                                    Remove Admin
                                                </button>
                                            </td>
                                        </tr>
                            ...
                            <div x-show="daAdmins.length === 0" class="text-center py-8 text-gray-500">
                                <svg class="w-12 h-12 mx-auto text-gray-300 mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
                                </svg>
                                <p>No DA Admins assigned yet</p>
                                <p class="text-sm">Click "Add DA Admin" to grant admin access to a user</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Add DA Admin Modal -->
    <div x-show="showAddAdminModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50" x-cloak>
        <div class="bg-white rounded-xl shadow-xl w-full max-w-md">
            <div class="p-6 border-b border-gray-200">
                <div class="flex justify-between items-center">
                    <div>
                        <h3 class="text-xl font-semibold text-gray-800">Add DA Admin</h3>
                        <p class="text-sm text-gray-500 mt-1">Enter the email of an existing user to grant DA Admin access</p>
                    </div>
            ...
            <div class="p-6">
                <form @submit.prevent="addDaAdmin()">
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 mb-2">User Email</label>
                        <input type="email" x-model="newAdminEmail" 
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" 
                               placeholder="user@example.com" required>
                        <p class="mt-2 text-xs text-gray-500">The user must already have a registered account</p>
                    </div>
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                        <div class="flex items-start">
                            ...
                            <div class="text-sm text-blue-800">
                                ...
                                <p class="mt-1">When this user logs in, they will automatically see the Admin Dashboard with full administrative access.</p>
                            </div>
                        </div>
                    </div>
                    <div class="flex justify-end space-x-3">
                        <button type="button" @click="showAddAdminModal = false" class="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50">Cancel</button>
                        <button type="submit" :disabled="addingAdmin" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50">
                            <span x-show="!addingAdmin">Add as DA Admin</span>
                            <span x-show="addingAdmin">Adding...</span>
                        </button>
                    </div>
                </form>
            </div>
            ...
            return {
                ...
                getRoleBadgeClass(role) {
                    const classes = {
                        ...
                        'DA Admin': 'bg-blue-100 text-blue-800',
                ...
                // DA Admin Management Functions
                async fetchDaAdmins() {
                    try {
                        const response = await fetch('{{ route("superadmin.api.admins") }}', {
                        ...
                        if (response.ok) {
                            const data = await response.json();
                            this.daAdmins = data.admins || [];
                        }
                    } catch (error) {
                        console.error('Error fetching DA Admins:', error);
                    }
                },
                ...
                async addDaAdmin() {
                    ...
                    try {
                        const response = await fetch('{{ route("superadmin.api.admins.add") }}', {
                            method: 'POST',
                            credentials: 'same-origin',
                            headers: {
                        ...
                        if (response.ok) {
                            ...
                            alert('Error: ' + (data.error || 'Failed to add DA Admin'));
                        }
                    } catch (error) {
                        console.error('Error adding DA Admin:', error);
                        alert('Error adding DA Admin. Please try again.');
                    } finally {
                ...
                async removeAdmin(admin) {
                    if (!confirm(`Are you sure you want to remove DA Admin access from ${admin.name}? They will be changed to a Farmer role.`)) {
                        return;
                    }
                    
                    try {
                        const response = await fetch(`{{ url('/superadmin/api/admins') }}/${admin.id}`, {
                            method: 'DELETE',
                            credentials: 'same-origin',
                            headers: {
                                'Accept': 'application/json',
                        ...
                        if (response.ok) {
                            ...
                            alert('Error: ' + (data.error || 'Failed to remove DA Admin'));
                        }
                    } catch (error) {
                        console.error('Error removing DA Admin:', error);
                        alert('Error removing DA Admin. Please try again.');
                    }
                }
            }
        }
