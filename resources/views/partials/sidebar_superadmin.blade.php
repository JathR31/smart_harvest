...
<aside class="w-64 bg-gradient-to-b from-purple-800 to-purple-900 text-white flex-shrink-0 overflow-y-auto">
    ...
    <nav class="p-4 space-y-1">
        ...
        <div class="mb-4">
            ...
            <a href="{{ route('superadmin.dashboard') }}" class="sidebar-item {{ request()->routeIs('superadmin.dashboard') ? 'active' : '' }} flex items-center space-x-3 px-4 py-3 rounded">
        ...
        <div class="mb-4">
            ...
            <a href="{{ route('superadmin.dashboard', ['tab' => 'logs']) }}" class="sidebar-item flex items-center space-x-3 px-4 py-3 rounded">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mb-4">
            ...
            <a href="{{ route('dashboard', ['view' => 'farmer']) }}" class="sidebar-item flex items-center space-x-3 px-4 py-3 rounded">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                </svg>
