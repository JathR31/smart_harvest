...
<body class="antialiased text-gray-700">
    ...
    <!-- QR Code Section -->
    <section class="py-10 px-4 bg-green-700">
        <div class="max-w-lg mx-auto">
            <div class="flex items-center bg-green-700 rounded-2xl border border-green-600 shadow-xl px-6 py-5 gap-6">
                <!-- QR Code -->
                <div class="flex-shrink-0 bg-white rounded-xl p-3 shadow-md">
                    <div id="qrCodeCanvas"></div>
                </div>
                <!-- Text -->
                <p class="text-yellow-400 text-xl font-semibold leading-snug" data-translate data-translate-id="qr-scan-label">Scan to download the app</p>
            </div>
        </div>
    </section>
