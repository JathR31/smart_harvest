    ...
    <div class="flex h-screen">
            ...
            <div class="mb-4">
                ...
                <a href="{{ route('admin.dataimport') }}" class="sidebar-item flex items-center space-x-3 px-4 py-3 rounded">
                    ...
                    <a href="#" class="sidebar-item flex items-center space-x-3 px-4 py-3 rounded">
                        ...
                        <span data-translate data-translate-id="menu-logs">Logs</span>
                    </a>
                </div>
            </nav>
        </aside>
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="bg-white shadow-sm p-4 flex justify-between items-center">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex items-center space-x-2 text-xs text-gray-500">
                        ...
                        <span data-translate data-translate-id="live-status">Live • Auto-refresh every 30s</span>
                    </div>
                </div>

                <div class="flex items-center space-x-4">
                    <div class="relative">
                        <input type="text" data-translate-placeholder data-translate-id="search-placeholder" placeholder="Search..." class="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 w-64">
                    ...
                    <div x-data="{ open: false }" class="relative">
                        <button @click="open = !open" id="languageDropdownBtn" class="px-3 py-2 border border-gray-300 rounded-lg flex items-center space-x-2 hover:bg-gray-50">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 5C11.783 10.77 8.07 15.61 3 18.129"/>
                            </svg>
                            <span class="text-sm">English</span>
                        </button>
                        <div x-show="open" @click.away="open = false" id="languageDropdownMenu" class="absolute right-0 mt-2 py-2 w-40 bg-white rounded-md shadow-xl border border-gray-200 z-50">
                            <button onclick="SmartHarvestTranslation.changeLanguage('en', 'English')" class="block w-full text-left px-4 py-2 hover:bg-gray-100 transition text-sm">English</button>
                            <button onclick="SmartHarvestTranslation.changeLanguage('tl', 'Tagalog')" class="block w-full text-left px-4 py-2 hover:bg-gray-100 transition text-sm">Tagalog</button>
                            <button onclick="SmartHarvestTranslation.changeLanguage('ilo', 'Ilocano')" class="block w-full text-left px-4 py-2 hover:bg-gray-100 transition text-sm">Ilocano</button>
                            <button onclick="SmartHarvestTranslation.changeLanguage('kan', 'Kankanaey')" class="block w-full text-left px-4 py-2 hover:bg-gray-100 transition text-sm">Kankanaey</button>
                            <button onclick="SmartHarvestTranslation.changeLanguage('ibl', 'Ibaloi')" class="block w-full text-left px-4 py-2 hover:bg-gray-100 transition text-sm">Ibaloi</button>
                        </div>
                    </div>
                    ...
                    <div x-data="{ open: false }" class="relative">
                        ...
                        <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-96 bg-white rounded-lg shadow-xl border border-gray-200 z-50">
                            <div class="p-4 border-b border-gray-200 flex justify-between items-center">
                                <h3 class="font-semibold text-gray-800" data-translate data-translate-id="notif-title">Notifications</h3>
                                <button @click="markAllAsRead()" class="text-sm text-green-600 hover:text-green-700" data-translate data-translate-id="mark-all-read">Mark all as read</button>
                            </div>
                    ...
                    <form method="POST" action="{{ route('logout') }}" onsubmit="sessionStorage.setItem('isLoggedOut','true');">
                        ...
                        <button type="submit" class="flex items-center space-x-2 px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-lg">
                            ...
                            <span data-translate data-translate-id="logout-btn">Logout</span>
                        </button>
                    </form>
                </div>
            </header>
            ...
            <main class="flex-1 overflow-y-auto p-6">
                <!-- Overview Stats -->
                <div class="mb-6">
                    <h3 class="text-sm uppercase text-gray-500 mb-4" data-translate data-translate-id="stats-overview">Overview</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <!-- Total Users -->
                        <div class="bg-white rounded-lg shadow p-6">
                            <div class="flex justify-between items-start">
                                <div>
                                    <p class="text-sm text-gray-500 mb-1" data-translate data-translate-id="stat-total-users">Total Users</p>
                                    <h3 class="text-3xl font-bold text-gray-800" x-text="stats.totalUsers"></h3>
                                    <p class="text-sm text-green-600 mt-2">
                                        <span x-text="'+' + stats.newUsersThisWeek"></span> <span data-translate data-translate-id="this-week">this week</span>
                                    </p>
                                </div>
                        ...
                        <div class="bg-white rounded-lg shadow p-6">
                            <div class="flex justify-between items-start">
                                <div>
                                    <p class="text-sm text-gray-500 mb-1" data-translate data-translate-id="stat-crop-data">Crop Data Records</p>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-2 bg-white rounded-lg shadow">
                        <div class="p-6 border-b border-gray-200">
                            <h3 class="text-lg font-semibold text-green-700" data-translate data-translate-id="section-recent-activity">Recent Activity</h3>
                        </div>
                    ...
                    <div class="bg-white rounded-lg shadow">
                        <div class="p-6 border-b border-gray-200">
                            <h3 class="text-lg font-semibold text-green-700" data-translate data-translate-id="section-validation-alerts">Data Validation Alerts</h3>
                        </div>
                        <div class="p-6">
                            <div class="space-y-4">
                                ...
                                <template x-if="dataAlerts.length === 0">
                                    <div class="text-center py-8">
                                        ...
                                        <p class="text-sm text-gray-500" data-translate data-translate-id="no-validation-alerts">No validation alerts</p>
                                    </div>
                                </template>
                            </div>
                        </div>
                ...
                <div class="mt-6 bg-white rounded-lg shadow">
                    <div class="p-6 border-b border-gray-200">
                        <h3 class="text-lg font-semibold text-green-700" data-translate data-translate-id="section-system-overview">System Overview</h3>
                    </div>
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <!-- Server Status -->
                            <div>
                                <h4 class="text-sm font-semibold text-gray-700 mb-4" data-translate data-translate-id="server-status">Server Status</h4>
                                <div class="space-y-3">
                                    <div class="flex justify-between items-center">
                                        <span class="text-sm text-gray-600" data-translate data-translate-id="api-response">API Response</span>
                                        <span class="px-2 py-1 bg-green-100 text-green-800 rounded text-xs font-semibold" data-translate data-translate-id="status-normal">Normal</span>
                                    </div>
                                    <div class="flex justify-between items-center">
                                        <span class="text-sm text-gray-600" data-translate data-translate-id="database">Database</span>
                                        <span class="px-2 py-1 bg-green-100 text-green-800 rounded text-xs font-semibold" data-translate data-translate-id="status-online">Online</span>
                                    </div>
                                    <div class="flex justify-between items-center">
                                        <span class="text-sm text-gray-600" data-translate data-translate-id="storage">Storage</span>
                            ...
                            <!-- Data Statistics -->
                            <div>
                                <h4 class="text-sm font-semibold text-gray-700 mb-4" data-translate data-translate-id="data-statistics">Data Statistics</h4>
                                <div class="space-y-3">
                                    <div class="flex justify-between items-center">
                                        <span class="text-sm text-gray-600" data-translate data-translate-id="crop-records">Crop Records</span>
                            ...
                            <!-- User Activity -->
                            <div>
                                <h4 class="text-sm font-semibold text-gray-700 mb-4" data-translate data-translate-id="user-activity">User Activity</h4>
                                <div class="space-y-3">
                                    <div class="flex justify-between items-center">
                                        <span class="text-sm text-gray-600" data-translate data-translate-id="active-today">Active Today</span>
                ...
                <div class="mt-6 bg-white rounded-lg shadow">
                    <div class="p-6 border-b border-gray-200 flex justify-between items-center">
                        <h3 class="text-lg font-semibold text-green-700" data-translate data-translate-id="section-recent-users">Recent Users</h3>
                        <a href="{{ route('admin.users') }}" class="text-sm text-green-600 hover:text-green-700 font-semibold" data-translate data-translate-id="view-all">View All</a>
                    </div>
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <thead class="bg-gray-50 border-b border-gray-200">
                                <tr>
                                    <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider" data-translate data-translate-id="table-name">Name</th>
                                    <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider" data-translate data-translate-id="table-email">Email</th>
                                    <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider" data-translate data-translate-id="table-location">Location</th>
                                    <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider" data-translate data-translate-id="table-registered">Registered</th>
                                    <th class="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider" data-translate data-translate-id="table-lastactive">Last Active</th>
                                </tr>
                            </thead>
